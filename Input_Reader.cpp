...
int Input::Data_Initialization()
{
	...
	electric_para.resistivity_CNT = 10;
    electric_para.resistivity_GNP_t = 10;
    electric_para.resistivity_GNP_surf = 10;
...
int Input::Read_visualization_flags(Visualization_flags &vis_flags, ifstream &infile)
{
    ...
    if (vis_flags.generated_nanoparticles<0||vis_flags.generated_nanoparticles>4) {
        hout<<"Error: Flag to export generated CNTs can only be 0, 1, 2, 3, or 4. Input was: "<<vis_flags.generated_nanoparticles<<endl;
        return 0;
    }
