...
public:
    ...
    int Calculate_resistance_cnt(const int &R_flag, const vector<Point_3D> &points_cnt, const long int &P1, const long int &P2, const double &radius, const Electric_para& electric_param, double &Re);
    ...
    int Calculate_junction_resistance(const Junction &j, const double &l1, const double &l2, const struct Electric_para &electric_param, double &Re);
