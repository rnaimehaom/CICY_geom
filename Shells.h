...
public:
    ...
    //
    int Generate_shells(const struct Geom_sample &sample, const vector<Point_3D> &points_cnt, const vector<GNP> &gnps, vector<vector<int> > &shells_cnt, vector<Shell> &shells_gnps);
